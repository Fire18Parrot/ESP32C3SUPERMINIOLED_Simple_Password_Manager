...
const unsigned char splashImage[360] U8X8_PROGMEM = {
  
};

// BLE Callbacks - CRITICAL FIX: Don't restart advertising immediately
class MyServerCallbacks : public BLEServerCallbacks {
  ...
  void onDisconnect(BLEServer* pServer) {
    ...
    // DON'T restart advertising here - causes reconnect loop
  }
};
...
void sendKeyReport(uint8_t modifier, uint8_t key) {
  ...
  // CRITICAL FIX: Don't include report ID in the actual data
...
void initBLE() {
  ...
  // CRITICAL: NO SECURITY/AUTHENTICATION
...
void loop() {
  ...
  if (bleEnabled && !bleConnected && !webServerActive) {
    ...
    if (millis() - lastAdvCheck > 30000) {  // Check every 30 seconds
      lastAdvCheck = millis();
